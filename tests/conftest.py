...
@pytest.fixture
def product_inserted() -> UUID:
    return UUID("")


@pytest.fixture
def product_in(product_inserted):
    return ProductIn(**product_data(), id=product_inserted)


@pytest.fixture
def product_up(product_inserted):
    return ProductUpdate(**product_data(), id=product_inserted)
